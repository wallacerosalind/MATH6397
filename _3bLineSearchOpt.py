#This file contains an adaptation of class Optimize (implemented in LineSearchOpt.py) for use by 3b
#to avoid changeing LineSearchOpt, which is accessed by 1-3a
import numpy as np
